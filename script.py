...
#final_list = taxonomizer.MapBucketTaxonomies(p_list)

# Catch vintage / collectibles :
#final_list = taxonomizer.MapVintageTaxonomies(p_list)

# Catch books :
#final_list = taxonomizer.MapBooks(p_list)



# Catch partial token sorted ratios (good for when nodes contain matching strings and have unequal length)
#final_list, rerun_list = taxonomizer.CompareTaxonomiesUsingTokens(p_list, g_list, index, threshold)
